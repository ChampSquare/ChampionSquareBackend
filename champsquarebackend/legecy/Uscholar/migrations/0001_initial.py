    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('right_answer_num', models.IntegerField(default=0)),
                ('wrong_answer_num', models.IntegerField(default=0)),
                ('unanswered_question_num', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('summary', models.CharField(default='2016 Second Paper2 Q', max_length=256)),
                ('description', models.TextField(blank=True)),
                ('picture', models.ImageField(blank=True, null=True, upload_to='question_pics/%Y-%m-%d/', verbose_name='Question Picture')),
                ('type', models.CharField(choices=[('mcq', 'Single Correct Choice'), ('mcc', 'Multiple Correct Choices'), ('integer', 'Answer in Integer'), ('paragraph', 'Paragraph Type'), ('match', 'Matching Type')], default='mcc', max_length=24)),
                ('question_section', models.CharField(blank=True, choices=[('sec1', 'Section One'), ('sec2', 'Section Two'), ('sec3', 'Section Three'), ('sec4', 'Section Four')], default='sec1', max_length=20, null=True)),
                ('points', models.FloatField(default=4.0)),
                ('subject', models.CharField(choices=[('physics', 'Physics'), ('chemistry', 'Chemistry'), ('mathematics', 'Mathematics'), ('biology', 'Biology')], default='physics', max_length=24)),
                ('active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('mcqtestcase', 'MCQ Testcase'), ('integertestcase', 'Integer Testcase')], default='mcqtestcase', max_length=24, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='IntegerTestCase',
            fields=[
                ('testcase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='Uscholar.TestCase')),
                ('correct', models.IntegerField(default=None)),
            ],
            bases=('Uscholar.testcase',),
        ),
        migrations.CreateModel(
            name='McqTestCase',
            fields=[
        ...
        migrations.AddField(
            model_name='testcase',
            name='question',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Uscholar.Question'),
        ),
        migrations.AddField(
            model_name='questionpaper',
            name='question_section',
            field=models.ManyToManyField(to='Uscholar.QuestionSection'),
        ),
        migrations.AddField(
            model_name='questionpaper',
            name='quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Uscholar.Quiz'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='questions_answered', to='Uscholar.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='questions_marked_for_review',
            field=models.ManyToManyField(related_name='question_marked_for_review', to='Uscholar.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='questions_unanswered',
            field=models.ManyToManyField(related_name='questions_unanswered', to='Uscholar.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='questions_visited',
            field=models.ManyToManyField(related_name='question_visited', to='Uscholar.Question'),
        ),
        migrations.AddField(
            model_name='answerpaper',
            name='user',
