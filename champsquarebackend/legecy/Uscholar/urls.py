...
urlpatterns = [
    ...
    #url(r'^register/$', generic.FormView.as_view(
    ...
    # url(r'^(?P<q_id>\d+)/clear_response/(?P<attempt_num>\d+)/(?P<questionpaper_id>\d+)/$',\
    #         views.clear_response),
    # url(r'^(?P<q_id>\d+)/mark_for_review_and_next/(?P<attempt_num>\d+)/(?P<questionpaper_id>\d+)/$',\
    ...
    #     views.skip),
    # url(r'^(?P<q_id>\d+)/skip_section/(?P<section>.+)/(?P<attempt_num>\d+)/(?P<questionpaper_id>\d+)/$',
    #     views.skip_section),
    # url(r'^(?P<q_id>\d+)/skip/(?P<next_q>\d+)/(?P<attempt_num>\d+)/(?P<questionpaper_id>\d+)/$',
    #     views.skip),
    url(r'^download_result/$', views.download_csv, name='result download'),
    url(r'download_paper/(?P<username>[\w.@+-]+)/$', views.download_answer_paper, name='paper save'),
    ...
    url(r'^manage/show_result/$', views.show_results, name='show_result'),
    url(r'^manage/show_result/(?P<questionpaper_id>\d+)/$', views.show_results, name='show_result'),
    ...
    url(r'^manage/add_user/$', views.add_user),
    ...
    url(r'^manage/show_students/$', views.show_students),
    ...
    url(r'^manage/quiz/designquestionpaper/(?P<quiz_id>\d+)/$', views.design_paper,
