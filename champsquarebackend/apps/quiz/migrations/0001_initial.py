# Generated by Django 2.2 on 2020-06-01 02:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('option', ckeditor_uploader.fields.RichTextUploadingField(verbose_name='option field')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz.Subject', verbose_name='Subject')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('mcq', 'Single Correct Choice'), ('mcc', 'Multiple Correct Choices'), ('integer', 'Answer in Integer'), ('paragraph', 'Paragraph Type')], default='mcq', max_length=50, verbose_name='type of question')),
                ...
                ('difficulty_level', models.CharField(blank=True, choices=[('easy', 'Easy'), ('medium', 'Medium'), ('hard', 'Hard')], max_length=20, null=True, verbose_name='difficulty level of question')),
                ('solution', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Solution of question')),
                ('subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subjects', to='quiz.Subject', verbose_name='subjects')),
                ('topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='topics', to='quiz.Topic', verbose_name='topic')),
            ],
            options={
                'abstract': False,
            },
