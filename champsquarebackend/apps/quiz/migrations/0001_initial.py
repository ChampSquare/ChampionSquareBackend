    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, help_text="Activate the quiz, won't be accessible if you don't activate it", verbose_name='Is Active?')),
        ...
        migrations.CreateModel(
            name='Attribute',
            fields=[
                ('abstractattribute_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='quiz.AbstractAttribute')),
            ],
            options={
                'abstract': False,
            },
            bases=('quiz.abstractattribute',),
        ),
        migrations.CreateModel(
            name='Quiz',
            fields=[
