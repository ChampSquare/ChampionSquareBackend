...
from champsquarebackend.core.utils import slugify
from champsquarebackend.core.validators import non_python_keyword
from champsquarebackend.models.fields import AutoSlugField, NullCharField
from champsquarebackend.models.fields.slugfield import SlugField
from champsquarebackend.utils.models import get_image_upload_path

CategoryQuerySet, ProductQuerySet = get_classes(
    'quiz.managers', ['CategoryQuerySet', 'ProductQuerySet'])
ProductAttributesContainer = get_class(
    'quiz.product_attributes', 'ProductAttributesContainer')
...
class AbstractQuizClass(models.Model):
    """
    ...
    options = models.ManyToManyField(
        'quiz.Option', blank=True, verbose_name=_("Options"))
...
class AbstractCategory(MP_Node):
    ...
    is_public = models.BooleanField(
        ...
        default=True,
        db_index=True,
        help_text=_("Show this category in search results and quiz listings."))
    ...
    def full_name(self):
        ...
        It's rarely used in champsquarebackend, but used to be stored as a CharField and is
    ...
    def full_slug(self):
        ...
        champsquarebackend used to store this as in the 'slug' model field, but this field
    ...
    def save(self, *args, **kwargs):
        """
        champsquarebackend traditionally auto-generated slugs from names. As that is
    ...
    def _get_absolute_url(self, parent_slug=None):
        ...
        approach.
        """
        return reverse('quiz:category', kwargs={
...
class AbstractProduct(models.Model):
    ...
    is_public = models.BooleanField(
        ...
        default=True,
        db_index=True,
        help_text=_("Show this product in search results and quiz listings."))
    ...
    product_options = models.ManyToManyField(
        'quiz.Option', blank=True, verbose_name=_("Product options"),
    ...
    recommended_products = models.ManyToManyField(
        'quiz.Product', through='ProductRecommendation', blank=True,
    ...
    categories = models.ManyToManyField(
        'quiz.Category', through='ProductCategory',
    ...
    def is_review_permitted(self, user):
        ...
        Default implementation respects champsquarebackend_ALLOW_ANON_REVIEWS and only
        ...
        """
        if user.is_authenticated or settings.champsquarebackend_ALLOW_ANON_REVIEWS:
...
class AbstractProductAttribute(models.Model):
    ...
    def save_value(self, product, value):   # noqa: C901 too complex
        ProductAttributeValue = get_model('quiz', 'ProductAttributeValue')
        try:
    ...
    def _validate_option(self, value, valid_values=None):
        if not isinstance(value, get_model('quiz', 'AttributeOption')):
            raise ValidationError(
...
class MissingProductImage(object):
    ...
    def symlink_missing_image(self, media_file_path):
        static_file_path = find('champsquarebackend/img/%s' % self.name)
