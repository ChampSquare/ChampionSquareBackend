...
class PageListView(ListView):
    ...
    """
    template_name = 'champsquarebackend/dashboard/pages/index.html'
    model = FlatPage
    form_class = PageSearchForm
    paginate_by = settings.SETTINGS_DASHBOARD_ITEMS_PER_PAGE
...
class PageCreateUpdateMixin(object):
    ...
    template_name = 'champsquarebackend/dashboard/pages/update.html'
    model = FlatPage
    form_class = PageUpdateForm
    context_object_name = 'page'

    def get_success_url(self):
        msg = render_to_string('champsquarebackend/dashboard/pages/messages/saved.html',
                               {'page': self.object})
...
class PageDeleteView(generic.DeleteView):
    template_name = 'champsquarebackend/dashboard/pages/delete.html'
    model = FlatPage
