...
from champsquarebackend.core.utils import redirect_to_referrer
from champsquarebackend.views.generic import BulkEditMixin

PageTitleMixin = get_class('user.mixins', 'PageTitleMixin')
Notification = get_model('communication', 'Notification')


class NotificationListView(PageTitleMixin, generic.ListView):
    model = Notification
    template_name = 'champsquarebackend/communication/notifications/list.html'
    context_object_name = 'notifications'
    paginate_by = settings.SETTINGS_NOTIFICATIONS_PER_PAGE
...
class DetailView(PageTitleMixin, generic.DetailView):
    model = Notification
    template_name = 'champsquarebackend/communication/notifications/detail.html'
