...
from champsquarebackend.apps.user.signals import user_registered
...
logger = logging.getLogger('champsquarebackend.user')
...
class RegisterUserMixin(object):
    ...
    def register_user(self, form):
        ...
        if getattr(settings, 'SETTINGS_SEND_REGISTRATION_EMAIL', True):
        ...
        try:
            ...
            # twice, this is about the only place in champsquarebackend where we don't
    ...
    def send_registration_email(self, user):
        ...
        UserDispatcher().send_registration_email_for_user(user, extra_context)
