...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('participate', '0003_auto_20200709_1849'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='videos', to='participate.Participate', verbose_name='Participant')),
            ],
            options={
