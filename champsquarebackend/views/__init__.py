...
def handler403(request, exception):
    return render(request, 'champsquarebackend/403.html', status=403)


def handler404(request, exception):
    return render(request, 'champsquarebackend/404.html', status=404)


def handler500(request):
    return render(request, 'champsquarebackend/500.html', status=500)
