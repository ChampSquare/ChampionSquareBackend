...
class ImageInput(FileInput):
    ...
    """
    template_name = 'champsquarebackend/forms/widgets/image_input_widget.html'
...
class DateTimeWidgetMixin(object):
    ...
    template_name = 'champsquarebackend/forms/widgets/date_time_picker.html'
...
class TimePickerInput(DateTimeWidgetMixin, forms.TimeInput):
    ...
    def get_context(self, name, value, attrs):
        ctx = super().get_context(name, value, attrs)
        ctx['div_attrs'] = {
            'data-champsquarebackendWidget': 'time',
...
class DatePickerInput(DateTimeWidgetMixin, forms.DateInput):
    ...
    def get_context(self, name, value, attrs):
        ctx = super().get_context(name, value, attrs)
        ctx['div_attrs'] = {
            'data-champsquarebackendWidget': 'date',
...
class DateTimePickerInput(DateTimeWidgetMixin, forms.DateTimeInput):
    ...
    def get_context(self, name, value, attrs):
        ctx = super().get_context(name, value, attrs)
        ctx['div_attrs'] = {
            'data-champsquarebackendWidget': 'datetime',
